...
@section('title')
<title>Sistem Akademik - Profil Siswa</title>
@endsection
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-user-circle fa-fw"></i> Profil Siswa
    </h1>
</div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-id-card"></i> Data Profil Siswa
                </h6>
                <div>
            ...
            <div class="card-body">
                ...
                <form id="profile-form" action="{{ route('siswa.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">NIS</label>
                        <div class="col-sm-9">
                            <input type="text" name="nis" class="form-control" value="{{ $profile->nis }}" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Jurusan</label>
                        <div class="col-sm-9">
                            <select id="jurusanSelect" name="jurusan_id" class="form-control" disabled>
                                <option value="">-- Pilih Jurusan --</option>
                                @foreach($jurusanList as $jurusan)
                                    <option value="{{ $jurusan->id }}" {{ $profile->jurusan_id == $jurusan->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select id="kelasSelect" name="kelas_id" class="form-control" disabled required>
                                <option value="">-- Pilih Kelas --</option>
                                @foreach($kelasList as $kelas)
                                    <option value="{{ $kelas->id }}"
                                        data-jurusan="{{ $kelas->jurusan_id }}"
                                        {{ $profile->kelas_id == $kelas->id ? 'selected' : '' }}>
                                        {{ $kelas->nama_kelas }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="tempat_lahir" class="form-control" value="{{ $profile->tempat_lahir }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" name="tanggal_lahir" class="form-control" value="{{ $profile->tanggal_lahir }}" readonly>
                        </div>
                    </div>
                    ...
                    <!-- Informasi Orang Tua -->
                    <h6 class="font-weight-bold text-primary mb-3 mt-4">
                        <i class="fas fa-users"></i> Informasi Orang Tua
                    </h6>
                    <hr class="mt-0 mb-3">

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Nama Ayah</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama_ayah" class="form-control" value="{{ $profile->nama_ayah }}" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">No HP Ayah</label>
                        <div class="col-sm-9">
                            <input type="text" name="no_hp_ayah" class="form-control" value="{{ $profile->no_hp_ayah }}" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Nama Ibu</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama_ibu" class="form-control" value="{{ $profile->nama_ibu }}" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">No HP Ibu</label>
                        <div class="col-sm-9">
                            <input type="text" name="no_hp_ibu" class="form-control" value="{{ $profile->no_hp_ibu }}" readonly>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-xl-4 col-lg-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body text-center">
                <div class="mb-3">
                    <img id="preview"
                        src="{{ $user->siswaProfile && $user->siswaProfile->photo ? asset('storage/' . $user->siswaProfile->photo) : asset('images/default-profile.png') }}"
                        alt="Foto Profil"
...
$(document).ready(function() {
    ...
    const excludedInputs = 'input[name="name"], input[name="email"], input[name="nis"], input:hidden';
