<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            @php
            $user = Auth::user();
            $photo = $user->siswaProfile && $user->siswaProfile->photo ? asset('storage/' . $user->siswaProfile->photo) : asset('images/default-profile.png');
            @endphp
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="{{ route('ProfileSiswa') }}">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    Profile
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('Siswa.UbahPassword') }}">
