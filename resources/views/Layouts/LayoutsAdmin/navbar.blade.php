...
<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
      action="{{ route('searchAdmin') }}" method="GET">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            @php
            $user = Auth::user();
            $photo = $user->adminProfile && $user->adminProfile->photo ? asset('storage/' . $user->adminProfile->photo) : asset('images/default-profile.png');
            @endphp
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated-grow-in"
                ...
                <a class="dropdown-item" href="{{ route('Admin.UbahPassword') }}">
