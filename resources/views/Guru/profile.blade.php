...
@section('title')
<title>Sistem Akademik - Profil Guru</title>
@endsection

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-user-circle fa-fw"></i> Profil Guru
    </h1>
</div>
<!-- Content Row -->
<div class="row">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-id-card"></i> Data Profil Guru
                </h6>
                <div>
            ...
            <div class="card-body">
                ...
                <form id="profile-form" action="{{ route('guru.profile.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label font-weight-bold">Bidang Keahlian</label>
                        <div class="col-sm-9">
                            <input type="text" name="bidang_keahlian" class="form-control" value="{{ $profile->bidang_keahlian }}" readonly>
                        </div>
                    </div>
    ...
    <div class="col-xl-4 col-lg-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body text-center">
                <div class="mb-3">
                    <img id="preview"
                        src="{{ $user->guruProfile && $user->guruProfile->photo ? asset('storage/' . $user->guruProfile->photo) : asset('images/default-profile.png') }}"
                        alt="Foto Profil"
